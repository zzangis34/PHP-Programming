...
<div class="limiter">
	<div class="container-table100">
		<div class="wrap-table100">
            ...
            <?php
                if(isset($_GET[num])) {
                    echo "<form  action=\"function/update.php?num=$_GET[num]\">";
                } else {
					...
					<table>
						...
						<tr>
                            ...
                            if(isset($_GET[num])) { //update 의 경우!
                                ...
                                <td class="column2"> <input name="order_id" type="number" value="<? echo($row[orderid])#TODO: 정보 표시 ?>" /> </td>
                                ...
                                <td class="column6"> $<span id="total"> <? echo($sum)#TODO: 정보 표시 ?> </span> </td>
                                <?php
                            } else {
                                ?>
